...
<div class="container">
	<form action="/auth/loginProc" method="post">
		...
		<a href="https://kauth.kakao.com/oauth/authorize?client_id=9a3c2df2d1449cfa54bd9018a758abaf&redirect_uri=http://localhost:8000/auth/kakao/callback&response_type=code">
